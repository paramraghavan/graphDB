I'll help you create a Python script that analyzes SQL statements to generate a source-to-target mapping and create a graph-friendly format for Neptune DB.
